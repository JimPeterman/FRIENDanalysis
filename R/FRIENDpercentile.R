...
FRIENDpercentile <- function(VO2, age, sex, ex_mode, ref_edition=2){
  ...
  if(ref_edition == 1 | ref_edition == "1"){
    ...
    m20 <- c(62.1, 57.8, 56.0, 54.2, 52.6, 50.9, 49.4, 48.2, 46.9,
             45.4, 44.2, 42.8, 41.0, 39.2, 37.3, 34.8, 32.0, 28.8, 24.8)
    m30 <- c(57.9, 54.3, 51.2, 48.7, 46.5, 45.1, 43.5, 41.9, 40.1,
             38.6, 37.4, 35.9, 34.3, 32.8, 31.3, 29.4, 27.2, 25.0, 20.6)
    m40 <- c(53.2, 49.5, 46.1, 44.0, 41.8, 40.0, 38.5, 37.2, 36.0,
             34.8, 33.4, 32.1, 31.1, 29.7, 28.4, 26.9, 25.4, 22.9, 19.7)
    m50 <- c(46.8, 42.7, 40.1, 37.5, 35.5, 34.1, 32.9, 31.8, 30.7,
             29.4, 28.2, 27.2, 26.2, 25.3, 23.9, 22.7, 21.4, 19.2, 16.5)
    m60 <- c(40.2, 36.4, 33.6, 31.6, 29.9, 28.7, 27.6, 26.5, 25.3,
             24.4, 23.6, 22.8, 21.8, 20.8, 19.7, 18.6, 17.5, 16.1, 13.8)
    m70 <- c(35.2, 29.6, 27.6, 26.3, 25.0, 23.9, 22.9, 22.3, 21.5,
             20.6, 19.9, 19.3, 18.5, 17.6, 16.8, 16.0, 15.0, 13.6, 11.6)
    m80 <- c(25.6, 23.6, 22.3, 21.8, 20.9, 20.4, 19.5, 18.8, 18.3,
             17.7, 17.0, 16.7, 16.3, 16.1, 15.9, 15.3, 13.9, 13.2, 12.2)

    f20 <- c(50.1, 47.3, 45.4, 44.1, 42.2, 41.2, 39.6, 38.0, 36.8,
             35.6, 34.2, 32.7, 31.3, 29.9, 28.6, 26.6, 24.5, 22.2, 19.3)
    f30 <- c(45.5, 41.1, 38.4, 36.2, 34.5, 33.3, 31.9, 30.7, 29.4,
             28.3, 27.3, 26.4, 25.4, 24.3, 23.1, 22.1, 20.7, 19.2, 16.6)
    f40 <- c(40.7, 37.5, 34.7, 32.8, 30.9, 29.8, 28.6, 27.7, 26.6,
             25.9, 24.9, 24.2, 23.2, 22.2, 21.3, 20.0, 19.0, 17.4, 15.3)
    f50 <- c(35.3, 31.8, 30.0, 28.4, 27.3, 26.4, 25.5, 24.7, 23.7,
             23.1, 22.3, 21.7, 21.0, 20.3, 19.5, 18.7, 17.6, 16.6, 14.5)
    f60 <- c(29.7, 27.3, 25.5, 24.1, 23.1, 22.2, 21.6, 20.8, 20.1,
             19.4, 18.8, 18.3, 17.7, 17.0, 16.4, 15.5, 14.7, 13.5, 12.0)
    f70 <- c(24.2, 22.8, 21.4, 20.6, 20.0, 19.2, 18.8, 18.2, 17.7,
             17.1, 16.7, 16.1, 15.7, 15.3, 14.8, 14.1, 13.7, 12.3, 11.3)
    f80 <- c(20.7, 19.9, 18.5, 18.0, 17.2, 16.6, 15.8, 15.5, 15.3,
             15.1, 14.6, 14.3, 13.8, 13.4, 12.8, 12.4, 11.9, 11.4, 10.7)
  ...
  if(ref_edition == 1 | ref_edition == "1"){
    ...
    m20 <- c(64.4, 61.0, 58.3, 55.8, 53.8, 51.4, 49.2, 47.2, 44.9,
             43.6, 42.0, 40.5, 38.3, 37.0, 35.7, 33.7, 31.9, 28.9, 24.6)
    m30 <- c(53.3, 45.6, 41.8, 38.1, 36.7, 35.3, 33.9, 31.5, 30.8,
             30.1, 29.1, 28.1, 27.2, 26.4, 24.5, 23.4, 21.4, 19.4, 16.2)
    m40 <- c(45.2, 40.5, 36.3, 34.6, 32.6, 31.3, 29.8, 28.9, 28.1,
             27.5, 26.3, 25.5, 24.9, 23.9, 22.8, 22.1, 21.3, 20.0, 18.3)
    m50 <- c(42.1, 35.8, 33.1, 31.4, 30.0, 28.4, 27.3, 26.4, 25.6,
             24.7, 24.0, 23.3, 22.7, 22.4, 21.7, 20.9, 19.6, 18.0, 14.9)
    m60 <- c(36.0, 30.5, 28.2, 26.6, 25.2, 24.4, 23.8, 23.2, 22.6,
             21.8, 21.3, 20.8, 20.1, 19.2, 18.7, 18.0, 16.7, 15.4, 12.8)
    m70 <- c(30.7, 27.1, 24.5, 23.2, 21.9, 21.3, 20.5, 19.9, 19.4,
             18.5, 18.2, 17.6, 17.1, 16.7, 16.0, 15.7, 14.4, 12.8, 10.1)
    m80 <- c(18.9, 18.8, 17.9, 17.5, 17.3, 17.2, 16.5, 15.5, 14.8,
             13.9, 13.3, 12.6, 12.2, 11.2, 10.8, 9.4, 9.0, 8.4, 7.9)

    f20 <- c(50.2, 45.0, 42.6, 40.9, 38.9, 37.2, 35.3, 34.0, 33.1,
             31.4, 30.3, 28.9, 27.3, 25.9, 24.1, 22.7, 20.9, 19.4, 17.3)
    f30 <- c(36.5, 31.7, 28.6, 26.8, 25.8, 24.6, 23.7, 23.1, 22.2,
             21.5, 20.8, 19.9, 19.3, 18.8, 17.9, 17.3, 16.4, 15.2, 13.9)
    f40 <- c(30.5, 26.8, 24.7, 23.5, 22.7, 21.9, 21.3, 20.5, 19.7,
             19.0, 18.6, 18.1, 17.3, 16.8, 16.0, 15.5, 14.9, 13.8, 12.7)
    f50 <- c(25.0, 22.6, 21.5, 20.7, 20.0, 19.3, 18.8, 18.2, 17.7,
             17.3, 16.9, 16.5, 16.1, 15.6, 15.2, 14.7, 14.3, 13.5, 12.5)
    f60 <- c(21.9, 20.3, 19.1, 18.6, 18.1, 17.6, 16.9, 16.5, 16.1,
             15.9, 15.5, 15.3, 14.9, 14.6, 14.2, 13.7, 13.2, 12.5, 11.3)
    f70 <- c(19.1, 18.0, 17.4, 16.8, 16.5, 16.0, 15.7, 15.3, 14.9,
             14.6, 14.4, 13.7, 13.6, 13.2, 12.8, 12.5, 12.0, 11.2, 10.1)
    f80 <- c(15.6, 14.1, 13.4, 13.1, 13.0, 12.7, 12.1, 11.6, 11.2,
             10.9, 10.4, 9.9, 9.4, 9.3, 9.0, 8.7, 8.6, 7.8, 6.8)
  }
